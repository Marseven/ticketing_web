    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="md:hidden px-4 py-3">
        ...
        <div class="flex items-center justify-between mb-2">
          ...
          <button
            @click="goBack"
            class="p-2.5 -ml-2 text-gray-600 hover:text-primea-blue transition-colors rounded-xl active:bg-gray-100"
          >
          ...
          <button
            @click="toggleMenu"
            class="p-2.5 -mr-2 text-primea-blue hover:text-primea-yellow transition-colors rounded-xl active:bg-gray-100"
          >
        ...
        <nav class="flex items-center space-x-8">
          ...
          <div class="relative" ref="eventsDropdown">
            <button
              ...
              class="flex items-center space-x-1 text-primea-blue hover:text-primea-yellow font-semibold transition-colors duration-200"
            >
            ...
            <transition name="dropdown">
              <div v-if="eventsDropdownOpen" class="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 border border-gray-100">
                <router-link
                  ...
                  class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200 font-semibold"
                >
                  Tous les événements
                </router-link>
                ...
                <router-link
                  ...
                  @click="closeEventsDropdown"
                  class="flex items-center px-4 py-2 text-sm text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200"
                >
                  {{ category.name }}
                </router-link>
              </div>
          ...
          <template v-else-if="!isAuthenticated">
            ...
            <router-link
              :to="{ name: 'register' }"
              class="bg-primea-blue text-white px-6 py-2.5 rounded-xl hover:bg-primea-yellow hover:text-primea-blue font-bold transition-all duration-200 shadow-lg"
            >
              Inscription
            </router-link>
          </template>
          ...
          <template v-else>
            ...
            <div class="relative" ref="dropdown">
              ...
              >
                <div class="w-9 h-9 bg-primea-blue text-white rounded-full flex items-center justify-center overflow-hidden">
                  <img
                    v-if="userAvatar"
                    :src="userAvatar"
                    :alt="userName"
              ...
              <transition name="dropdown">
                <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl py-2 border border-gray-100">
                  <div class="px-4 py-3 border-b border-gray-200">
                    ...
                    <p class="text-xs text-primea-yellow font-medium mt-1">{{ userRoleText }}</p>
                  </div>

                  <template v-if="isAdmin">
                    <router-link :to="{ name: 'admin-dashboard' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                  ...
                  <template v-else-if="isOrganizer">
                    <router-link :to="{ name: 'organizer-dashboard' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                      <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                      </svg>
                      Tableau de bord
                    </router-link>
                    <router-link :to="{ name: 'organizer-events' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                      <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <template v-else>
                    <router-link :to="{ name: 'my-tickets' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                      <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/>
                      </svg>
                      Mes tickets
                    </router-link>
                    <router-link :to="{ name: 'my-orders' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                      <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <router-link :to="{ name: 'profile' }" @click="closeDropdown" class="flex items-center px-4 py-2 text-primea-blue hover:bg-primea-blue/10 transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button @click="logout" class="flex items-center w-full px-4 py-2 text-primea-blue hover:bg-red-50 hover:text-red-600 transition-colors duration-200 text-left">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex-shrink-0 px-4 py-3 bg-white border-b">
            <div class="flex items-start justify-between">
              ...
              <div class="flex flex-col items-end flex-1 ml-4">
                <!-- Bouton fermer -->
                <button @click="closeMenu" class="text-primea-blue p-2 -mr-2 -mt-2 mb-2">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <nav class="flex-1 overflow-y-auto">
            <div class="p-6">
              <div class="w-4/5 mx-auto space-y-4">
                ...
                <!-- Events with submenu -->
                <div>
                  <button @click="toggleMobileEventsSubmenu" class="flex items-center justify-between w-full text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                    <span>Événements</span>
                  ...
                  <div v-if="mobileEventsSubmenuOpen" class="ml-4 mt-2 space-y-2">
                    <router-link :to="{ name: 'events' }" @click="closeMenu" class="block text-white/80 text-base py-2 hover:text-primea-yellow transition-colors">
                      Tous les événements
                    </router-link>
                    <router-link
                      v-for="category in categories"
                      ...
                      :to="{ name: 'events', query: { category: category.id } }"
                      @click="closeMenu"
                      class="block text-white/80 text-sm py-2 hover:text-primea-yellow transition-colors"
                    >
                      {{ category.name }}
                    </router-link>
                  </div>
                ...
                <router-link :to="{ name: 'ticket-retrieve' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                  Récupérer mon ticket
                </router-link>

                <template v-if="!isAuthenticated">
                  <div class="pt-6 space-y-3 flex flex-col">
                    <router-link :to="{ name: 'login' }" @click="closeMenu" class="block w-full text-center bg-primea-blue text-white py-3 px-6 rounded-lg font-bold hover:bg-primea-yellow hover:text-primea-blue transition-colors">
                      Connexion
                    </router-link>
                    <router-link :to="{ name: 'register' }" @click="closeMenu" class="block w-full text-center border-2 border-white text-white py-3 px-6 rounded-lg font-bold hover:bg-white hover:text-primea-blue transition-colors">
                      Inscription
                    </router-link>
                  </div>
                </template>
                ...
                <template v-else>
                  <div class="pt-6 border-t border-gray-700">
                    ...
                    <template v-if="isAdmin">
                      <router-link :to="{ name: 'admin-dashboard' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                        Administration
                      </router-link>
                    </template>

                    <template v-else-if="isOrganizer">
                      <router-link :to="{ name: 'organizer-dashboard' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                        Tableau de bord
                      </router-link>
                      <router-link :to="{ name: 'organizer-events' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                        Mes événements
                      </router-link>
                    </template>

                    <template v-else>
                      <router-link :to="{ name: 'my-tickets' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                        Mes tickets
                      </router-link>
                    </template>

                    <router-link :to="{ name: 'profile' }" @click="closeMenu" class="block text-white text-lg py-3 hover:text-primea-yellow transition-colors">
                      Mon profil
                    </router-link>
