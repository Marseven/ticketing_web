  ...
  <div class="ticket-component bg-white rounded-primea-xl overflow-hidden font-primea max-w-sm shadow-primea-lg">
    ...
    <div class="ticket-actions p-4 bg-white flex flex-col sm:flex-row gap-3">
      <button
        ...
        class="flex-1 bg-primea-blue text-white py-3 px-4 rounded-primea font-bold text-sm hover:bg-primea-blue/80 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl min-h-[48px]"
      >
