  ...
  <div class="ticket-component bg-white rounded-primea-xl overflow-hidden font-primea max-w-sm shadow-primea-lg">
    ...
    <div class="ticket-actions p-4 bg-white flex flex-col sm:flex-row gap-3">
      <button
        ...
        class="btn-view flex-1 py-3 px-4 rounded-primea font-bold text-sm transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl min-h-[48px]"
      >
      ...
      <button
        ...
        class="btn-download flex-1 py-3 px-4 rounded-primea font-bold text-sm transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl min-h-[48px]"
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5 flex-shrink-0">
...
.btn-view:hover {
  background-color: rgba(39, 45, 99, 0.8);
}
...
.btn-download:hover {
  background-color: rgba(250, 181, 17, 0.8);
}
