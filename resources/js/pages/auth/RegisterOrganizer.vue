        ...
        <div class="flex">
          ...
          <div class="ml-3">
            <p class="text-sm text-blue-700">
              <strong>À noter :</strong> Votre compte organisateur sera soumis à vérification par notre équipe.
...
const handleRegister = async () => {
  ...
  try {
    ...
    router.push({
      ...
      query: { message: 'Inscription réussie ! Votre compte est en attente de vérification.' }
    })
