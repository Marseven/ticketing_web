      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="mt-8 md:mt-12 bg-white md:bg-white/10 md:backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 border border-gray-200 md:border-white/20">
          ...
          <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
            <a href="mailto:contact@primea.ga" class="flex items-center justify-center px-4 md:px-6 py-3 bg-primea-blue text-white rounded-xl hover:bg-primea-yellow hover:text-primea-blue transition-all duration-200 shadow-lg font-semibold text-sm md:text-base">
