        ...
        <div class="max-w-4xl mx-auto text-center">
          ...
          <div class="mb-8">
            <router-link
              ...
              class="inline-block bg-blue-950 text-white px-8 py-3 rounded-lg text-sm font-semibold hover:bg-opacity-90 transition-colors shadow-lg"
            >
              Créateur d'événements
            </router-link>
          </div>

          <!-- Links - Selon maquette Primea : Récupérer à gauche, Nous contacter à droite -->
