      ...
      <nav class="mt-8 px-4">
        <div class="space-y-2">
          ...
          <router-link to="/admin/dashboard" 
                       ...
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/dashboard' }">
          ...
          <router-link to="/admin/users" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/users' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/organizers" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/organizers' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/events" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/events' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/orders" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/orders' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/payments" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/payments' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/payouts" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/payouts' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/balance-config" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/balance-config' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/reports" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/reports' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
