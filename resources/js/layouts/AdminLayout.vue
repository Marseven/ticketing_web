  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0" 
      ...
      <div class="flex items-center justify-center h-16 px-4" style="background-color: #272d63;">
        <h1 class="text-xl font-bold text-white">Primea Admin</h1>
      </div>
      ...
      <nav class="mt-8 px-4">
        <div class="space-y-2">
          ...
          <router-link to="/admin/dashboard" 
                       ...
                       :class="{ 'text-white border-r-2': $route.path === '/admin/dashboard' }"
                       :style="$route.path === '/admin/dashboard' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/dashboard' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/dashboard' ? '#272d63' : 'transparent'">
          ...
          <router-link to="/admin/users" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/users' }"
                       :style="$route.path === '/admin/users' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/users' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/users' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/organizers" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/organizers' }"
                       :style="$route.path === '/admin/organizers' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/organizers' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/organizers' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/events" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/events' }"
                       :style="$route.path === '/admin/events' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/events' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/events' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/orders" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/orders' }"
                       :style="$route.path === '/admin/orders' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/orders' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/orders' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/payments" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/payments' }"
                       :style="$route.path === '/admin/payments' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/payments' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/payments' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/payouts" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/payouts' }"
                       :style="$route.path === '/admin/payouts' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/payouts' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/payouts' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/balance-config" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/balance-config' }"
                       :style="$route.path === '/admin/balance-config' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/balance-config' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/balance-config' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/categories" 
                       ...
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/categories' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/venues" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                       :class="{ 'bg-blue-50 text-blue-700 border-r-2 border-blue-600': $route.path === '/admin/venues' }">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/admin/reports" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors duration-200"
                       :class="{ 'text-white border-r-2': $route.path === '/admin/reports' }"
                       :style="$route.path === '/admin/reports' ? { backgroundColor: '#272d63', borderColor: '#fab511' } : { backgroundColor: 'transparent' }"
                       @mouseover="$event.currentTarget.style.backgroundColor = $route.path === '/admin/reports' ? '#272d63' : '#fab511'"
                       @mouseleave="$event.currentTarget.style.backgroundColor = $route.path === '/admin/reports' ? '#272d63' : 'transparent'">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
